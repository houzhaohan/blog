<template>
  <div class="post-content">
    <h2>霍尔木兹的导弹，击穿了华尔街的围墙</h2>
    <p>美军袭击伊朗，霍尔木兹海峡风声鹤唳。按照旧世界的规则，油价飞涨，只有期货市场里的少数玩家能从中获利。</p>
    <p>但这一次，不同了。</p>
    ...
    <p>当一切资产都能以代币形式自由流通，世界将进入一个前所未有的“超流动性”时代。地理边界被消解，中介层级被压缩，资产所有权的颗粒度从“一桶”变成“一滴”。</p>
